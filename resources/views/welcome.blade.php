                ...
                <main class="mt-6">
                    ...
                    <div  class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>{{ $category->name }}</td>
                                        <td>{{ $category->is_publish == 1 ? 'Yes' : 'No' }}</td>
                        ...
                        <div class="pagination">
                            ...
                            @else
                                <a href="{{ $categories->previousPageUrl() }}" class="btn">Previous</a>
                            @endif
                        
                            @foreach ($categories as $page => $item)
                                @if ($page + 1 == $categories->currentPage())
                                    <button class="btn page-number active">{{ $page + 1 }}</button>
                                @else
                                    <a href="{{ $categories->url($page + 1) }}" class="btn page-number">{{ $page + 1 }}</a>
                                @endif
                            @endforeach
                        
                            @if ($categories->hasMorePages())
                                <a href="{{ $categories->nextPageUrl() }}" class="btn">Next</a>
                            @else
