...
<head>
    ...
    <style>
        ...
        *,
        ...
        .flex-container form input[type="text"] {
            padding: 0.5rem;
        ...
        .flex-container form input[type="text"]:focus {
            border-color: #FF2D20;
        }
        ...
        .flex-container form select:focus {
            border-color: #FF2D20;
        }
                    ...
                    <div class="flex-container">
                        ...
                        <form action="{{ route('category.store') }}" method="POST">
                            ...
                            <select name="is_publish" id="is_publish">
                                <option value="1" @selected((old('is_publish') ?? $category->is_publish) == 1)>Yes</option>
                                <option value="0" @selected((old('is_publish') ?? $category->is_publish) == 0)>No</option>
                            </select>
